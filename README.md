...
- ### Using the installation script
    ...
    - ```
      ...
      ```
    - It will ask you if you want to select a specific background from the `./backgrounds/` directory- ### Manually
...
- #### ...with systemd
    ...
    - Copy `./assets/minegrub-update.service` to `/etc/systemd/system` (The installation script does that for you)
